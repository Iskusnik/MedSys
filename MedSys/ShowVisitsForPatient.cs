    ...
    public partial class ShowVisitsForPatient : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                switch (comboBox1.SelectedIndex)
                {
                    ...
                    case 1:
                        {
                            var thisPersonVisits = (from visit in patient.TimeForVisit where (visit.VisitTime > DateTime.Now) select new { Время_начала_приёма = visit.VisitTime, Имя_врача = visit.Doctor.FullName, Корпус = visit.Cabinet.Corpus.Name, Этаж = visit.Cabinet.Floor.ToString(), Кабинет = visit.Cabinet.Num.ToString() }).ToList();
                            dataGridView1.Columns.Clear();
                            dataGridView1.Columns.Add("Время начала приёма", "Время начала приёма");
                            dataGridView1.Columns.Add("Имя врача", "Имя врача");
                            dataGridView1.Columns.Add("Корпус", "Корпус");
